...
/** 
     * an enum.
     * каждому значению enum соответсвует своё состояние решений трёхчлена
     */

typedef enum
{
    KV_ONE, /**< квадратное уравнение; корень один */  
    KV_TWO,/**< квадратное уравнение; кореня два */  
    KV_ZERO,/**< квадратное уравнение; корней нет */  
    LIN_ONE, /**< линейное уравнение; корень один */  
    LIN_ZERO, /**< линейное уравнение; корней нет */  
    LIN_INF /**< линейное уравнение; корней бесконечное множество */  
} KORNI;
